...
public:
	...
	TMulticastInlineDelegate<void(class APAWN_SystemShockCharacter_C* Character)> CharacterDied;                                     // 0x0500(0x0010)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, BlueprintAssignable, BlueprintCallable)
	TMulticastInlineDelegate<void(class APAWN_SystemShockCharacter_C* Character)> OnCharacterInitialized;                            // 0x0510(0x0010)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, BlueprintAssignable, BlueprintCallable)
	...
	TMulticastInlineDelegate<void(class APAWN_SystemShockCharacter_C* Character)> OnBecomeUndetectable;                              // 0x0528(0x0010)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, BlueprintAssignable, BlueprintCallable)
