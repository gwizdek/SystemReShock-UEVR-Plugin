...
public:
	...
	TMulticastInlineDelegate<void(class USoundCue* SoundCue, float StartTime)> AudioLogCueStarted;                                // 0x0128(0x0010)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, BlueprintAssignable, BlueprintCallable)
	TMulticastInlineDelegate<void(class USoundCue* SoundCue)> AudioLogCueFinished;                               // 0x0138(0x0010)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, BlueprintAssignable, BlueprintCallable)
