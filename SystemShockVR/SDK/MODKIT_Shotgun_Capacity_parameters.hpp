...
static_assert(alignof(MODKIT_Shotgun_Capacity_C_GetModifiedWeaponMode) == 0x000008, "Wrong alignment on MODKIT_Shotgun_Capacity_C_GetModifiedWeaponMode");
static_assert(sizeof(MODKIT_Shotgun_Capacity_C_GetModifiedWeaponMode) == 0x000320, "Wrong size on MODKIT_Shotgun_Capacity_C_GetModifiedWeaponMode");
static_assert(offsetof(MODKIT_Shotgun_Capacity_C_GetModifiedWeaponMode, WeaponMode) == 0x000000, "Member 'MODKIT_Shotgun_Capacity_C_GetModifiedWeaponMode::WeaponMode' has a wrong offset!");
static_assert(offsetof(MODKIT_Shotgun_Capacity_C_GetModifiedWeaponMode, ResultMode) == 0x000100, "Member 'MODKIT_Shotgun_Capacity_C_GetModifiedWeaponMode::ResultMode' has a wrong offset!");
static_assert(offsetof(MODKIT_Shotgun_Capacity_C_GetModifiedWeaponMode, WeaponProperties) == 0x000200, "Member 'MODKIT_Shotgun_Capacity_C_GetModifiedWeaponMode::WeaponProperties' has a wrong offset!");
