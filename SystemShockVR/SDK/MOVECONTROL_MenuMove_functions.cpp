...
#include "MOVECONTROL_MenuMove_classes.hpp"
#include "MOVECONTROL_MenuMove_parameters.hpp"
...
void UMOVECONTROL_MenuMove_C::UpdateMoveControl(const struct FVector2D& MoveInput, const struct FVector2D& LookInput, const struct FSTRUCT_MoveControlParams& ControlParams, TArray<float>& ActionInputValues, float MoveInputScale, float Delta_Time, bool* ShouldExpire)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("MOVECONTROL_MenuMove_C", "UpdateMoveControl");

	Params::MOVECONTROL_MenuMove_C_UpdateMoveControl Parms{};
...
// Function MOVECONTROL_MenuMove.MOVECONTROL_MenuMove_C.ExpireNextFrame
// (Public, BlueprintCallable, BlueprintEvent)

void UMOVECONTROL_MenuMove_C::ExpireNextFrame()
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("MOVECONTROL_MenuMove_C", "ExpireNextFrame");
...
void UMOVECONTROL_MenuMove_C::InitializeMoveControl(class APAWN_Hacker_Simple_C* Player_0, float GameTime, const struct FSTRUCT_MoveControlParams& InitialControlParams, bool* Result)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("MOVECONTROL_MenuMove_C", "InitializeMoveControl");

	Params::MOVECONTROL_MenuMove_C_InitializeMoveControl Parms{};
