...
public:
	...
	TMulticastInlineDelegate<void(class UCOMP_CircuitMesh_C* Circuit, ENUM_PowerState PowerState)> PoweredStateChanged;                               // 0x0538(0x0010)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, BlueprintAssignable, BlueprintCallable)
