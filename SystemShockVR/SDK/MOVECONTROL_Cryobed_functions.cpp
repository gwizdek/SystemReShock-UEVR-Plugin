...
#include "MOVECONTROL_Cryobed_classes.hpp"
#include "MOVECONTROL_Cryobed_parameters.hpp"
...
void UMOVECONTROL_Cryobed_C::UpdateMoveControl(const struct FVector2D& MoveInput, const struct FVector2D& LookInput, const struct FSTRUCT_MoveControlParams& ControlParams, TArray<float>& ActionInputValues, float MoveInputScale, float Delta_Time, bool* ShouldExpire)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("MOVECONTROL_Cryobed_C", "UpdateMoveControl");

	Params::MOVECONTROL_Cryobed_C_UpdateMoveControl Parms{};
...
// Function MOVECONTROL_Cryobed.MOVECONTROL_Cryobed_C.ExpireCryobedMovement
// (Public, BlueprintCallable, BlueprintEvent)

void UMOVECONTROL_Cryobed_C::ExpireCryobedMovement()
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("MOVECONTROL_Cryobed_C", "ExpireCryobedMovement");
...
void UMOVECONTROL_Cryobed_C::InitializeMoveControl(class APAWN_Hacker_Simple_C* Player_0, float GameTime, const struct FSTRUCT_MoveControlParams& InitialControlParams, bool* Result)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("MOVECONTROL_Cryobed_C", "InitializeMoveControl");

	Params::MOVECONTROL_Cryobed_C_InitializeMoveControl Parms{};
