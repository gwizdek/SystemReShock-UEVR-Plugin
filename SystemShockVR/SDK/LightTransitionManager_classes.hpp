...
public:
	...
	TMulticastInlineDelegate<void()>              OnTransitionFinished;                              // 0x0068(0x0010)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, BlueprintAssignable, BlueprintCallable)
