...
{
public:
	TMulticastInlineDelegate<void(EHeartBeatEvent EventType)> OnHeartBeat;                                       // 0x0028(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
