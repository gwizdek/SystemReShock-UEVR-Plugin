...
{
public:
	TMulticastInlineDelegate<void(class APlayerController* PlayerController)> OnPausedEvent;                                     // 0x02C0(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, Protected, NativeAccessSpecifierProtected)
	TMulticastInlineDelegate<void()>              OnUnpausedEvent;                                   // 0x02D0(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, Protected, NativeAccessSpecifierProtected)
