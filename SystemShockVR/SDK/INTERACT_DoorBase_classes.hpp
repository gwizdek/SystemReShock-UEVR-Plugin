...
public:
	...
	TMulticastInlineDelegate<void(class AINTERACT_DoorBase_C* Door, ENUM_DoorState State)> OnDoorStateChanged;                                // 0x05E0(0x0010)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, BlueprintAssignable, BlueprintCallable)
