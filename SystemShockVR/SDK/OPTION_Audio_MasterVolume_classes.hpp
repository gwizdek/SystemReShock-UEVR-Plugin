...
{
public:
	struct FPointerToUberGraphFrame               UberGraphFrame_OPTION_Audio_MasterVolume_C;        // 0x03A8(0x0008)(ZeroConstructor, Transient, DuplicateTransient)

public:
	void ExecuteUbergraph_OPTION_Audio_MasterVolume(int32 EntryPoint);
...
static_assert(sizeof(UOPTION_Audio_MasterVolume_C) == 0x0003B0, "Wrong size on UOPTION_Audio_MasterVolume_C");
static_assert(offsetof(UOPTION_Audio_MasterVolume_C, UberGraphFrame_OPTION_Audio_MasterVolume_C) == 0x0003A8, "Member 'UOPTION_Audio_MasterVolume_C::UberGraphFrame_OPTION_Audio_MasterVolume_C' has a wrong offset!");
