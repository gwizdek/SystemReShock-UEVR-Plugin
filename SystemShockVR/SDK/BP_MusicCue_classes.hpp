...
public:
	...
	TMulticastInlineDelegate<void(class UBP_MusicCue_C* MusicCue)> OnMusicFinished;                                   // 0x00A0(0x0010)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, BlueprintAssignable, BlueprintCallable)
	...
	TMulticastInlineDelegate<void(int32 NumBars, float CurrentExploreMusicIntensity, float CurrentCombatMusicIntensity)> OnMeasure;                                         // 0x00C0(0x0010)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, BlueprintAssignable, BlueprintCallable)
