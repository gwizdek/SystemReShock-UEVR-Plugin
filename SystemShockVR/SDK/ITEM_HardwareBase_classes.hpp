...
public:
	...
	TMulticastInlineDelegate<void(bool Activated, bool MagLocked)> OnHardwareStateChanged;                            // 0x0220(0x0010)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, BlueprintAssignable, BlueprintCallable)
