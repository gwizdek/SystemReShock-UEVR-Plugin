...
#include "MODKIT_PlasmaRifle_Energy_classes.hpp"
#include "MODKIT_PlasmaRifle_Energy_parameters.hpp"
...
void UMODKIT_PlasmaRifle_Energy_C::TryApplyWeaponModifications(class UITEM_WeaponBase_C* Weapon, bool DuringInitialization, bool* Result)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("MODKIT_PlasmaRifle_Energy_C", "TryApplyWeaponModifications");

	Params::MODKIT_PlasmaRifle_Energy_C_TryApplyWeaponModifications Parms{};
...
void UMODKIT_PlasmaRifle_Energy_C::GetModifiedWeaponMode(const struct FSTRUCT_WeaponMode& WeaponMode, struct FSTRUCT_WeaponMode* ResultMode)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("MODKIT_PlasmaRifle_Energy_C", "GetModifiedWeaponMode");

	Params::MODKIT_PlasmaRifle_Energy_C_GetModifiedWeaponMode Parms{};
