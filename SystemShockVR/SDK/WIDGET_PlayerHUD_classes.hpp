...
public:
	...
	TMulticastInlineDelegate<void(class UITEM_Base_C* NewItem)> HoverItemChanged;                                  // 0x0818(0x0010)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, BlueprintAssignable, BlueprintCallable)
