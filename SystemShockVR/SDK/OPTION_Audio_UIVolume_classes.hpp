...
public:
	...
	{
		return StaticBPGeneratedClassImpl<"OPTION_Audio_UIVolume_C">();
	}
	static class UOPTION_Audio_UIVolume_C* GetDefaultObj()
	{
		return GetDefaultObjImpl<UOPTION_Audio_UIVolume_C>();
	}
};
