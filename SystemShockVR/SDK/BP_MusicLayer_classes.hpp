...
public:
	...
	int32                                         Pre_Delay__measures_;                              // 0x0030(0x0004)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, ExposeOnSpawn, HasGetValueTypeHash)
...
static_assert(offsetof(UBP_MusicLayer_C, Pre_Delay__measures_) == 0x000030, "Member 'UBP_MusicLayer_C::Pre_Delay__measures_' has a wrong offset!");
