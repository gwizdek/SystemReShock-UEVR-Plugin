...
void USAVE_Settings_C::SetSprintToggle(bool NewValue)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("SAVE_Settings_C", "SetSprintToggle");

	Params::SAVE_Settings_C_SetSprintToggle Parms{};
...
void USAVE_Settings_C::ApplySprintToggle(bool NewValue)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("SAVE_Settings_C", "ApplySprintToggle");

	Params::SAVE_Settings_C_ApplySprintToggle Parms{};
...
void USAVE_Settings_C::GetSprintToggle(bool* Result)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("SAVE_Settings_C", "GetSprintToggle");

	Params::SAVE_Settings_C_GetSprintToggle Parms{};
...
void USAVE_Settings_C::GetSprintToggleProfileValue(const class FString& Culture, const class FString& Platform, bool* Result)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("SAVE_Settings_C", "GetSprintToggleProfileValue");

	Params::SAVE_Settings_C_GetSprintToggleProfileValue Parms{};
