...
public:
	...
	TMulticastInlineDelegate<void(int32 TotalPowerLevel)> OnPowerLevelChanged;                               // 0x0738(0x0010)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, BlueprintAssignable, BlueprintCallable)
