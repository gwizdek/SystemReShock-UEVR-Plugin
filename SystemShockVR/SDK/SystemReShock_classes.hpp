...
{
public:
	TMulticastInlineDelegate<void(EChessSquare SelectedSquare)> OnPieceSelected;                                   // 0x0028(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, Protected, NativeAccessSpecifierProtected)
	TMulticastInlineDelegate<void(EChessSquare SourceSquare, EChessSquare TargetSquare)> OnPieceMoved;                                      // 0x0038(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, Protected, NativeAccessSpecifierProtected)
	TMulticastInlineDelegate<void(EChessSquare SourceSquare, EChessSquare CaptureSquare)> OnPieceCaptured;                                   // 0x0048(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, Protected, NativeAccessSpecifierProtected)
	TMulticastInlineDelegate<void(bool bPlayerVictory)> OnGameOver;                                        // 0x0058(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, Protected, NativeAccessSpecifierProtected)
...
{
public:
	TMulticastInlineDelegate<void(int32 InstanceIndex, struct FVector& ImpactLocation)> OnInstanceCollision;                               // 0x0588(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
