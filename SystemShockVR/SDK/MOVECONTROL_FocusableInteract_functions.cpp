...
#include "MOVECONTROL_FocusableInteract_classes.hpp"
#include "MOVECONTROL_FocusableInteract_parameters.hpp"


namespace SDK
{

// Function MOVECONTROL_FocusableInteract.MOVECONTROL_FocusableInteract_C.OnFinishedTransitioning__DelegateSignature
// (Public, Delegate, BlueprintCallable, BlueprintEvent)

void UMOVECONTROL_FocusableInteract_C::OnFinishedTransitioning__DelegateSignature()
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("MOVECONTROL_FocusableInteract_C", "OnFinishedTransitioning__DelegateSignature");
...
void UMOVECONTROL_FocusableInteract_C::InitializeMoveControl(class APAWN_Hacker_Simple_C* Player_0, float GameTime, const struct FSTRUCT_MoveControlParams& InitialControlParams, bool* Result)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("MOVECONTROL_FocusableInteract_C", "InitializeMoveControl");

	Params::MOVECONTROL_FocusableInteract_C_InitializeMoveControl Parms{};
...
void UMOVECONTROL_FocusableInteract_C::UpdateMoveControl(const struct FVector2D& MoveInput, const struct FVector2D& LookInput, const struct FSTRUCT_MoveControlParams& ControlParams, TArray<float>& ActionInputValues, float MoveInputScale, float Delta_Time, bool* ShouldExpire)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("MOVECONTROL_FocusableInteract_C", "UpdateMoveControl");

	Params::MOVECONTROL_FocusableInteract_C_UpdateMoveControl Parms{};
...
// Function MOVECONTROL_FocusableInteract.MOVECONTROL_FocusableInteract_C.ExpireFocusMovement
// (Public, BlueprintCallable, BlueprintEvent)

void UMOVECONTROL_FocusableInteract_C::ExpireFocusMovement()
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("MOVECONTROL_FocusableInteract_C", "ExpireFocusMovement");
