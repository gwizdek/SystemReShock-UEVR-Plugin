...
public:
	...
	TMulticastInlineDelegate<void(class UITEM_WeaponBase_C* EquippedWeapon)> OnEquippedWeaponChanged;                           // 0x02F0(0x0010)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, BlueprintAssignable, BlueprintCallable)
	TMulticastInlineDelegate<void(class UITEM_WeaponBase_C* Weapon)> OnWeaponDrawn;                                     // 0x0300(0x0010)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, BlueprintAssignable, BlueprintCallable)
	TMulticastInlineDelegate<void(class UITEM_WeaponBase_C* Weapon)> OnWeaponHolstered;                                 // 0x0310(0x0010)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, BlueprintAssignable, BlueprintCallable)
