...
public:
	...
	struct FQuat                                  WorldRotation;                                     // 0x0010(0x0010)(ConstParm, Parm, IsPlainOldData, NoDestructor, NativeAccessSpecifierPublic)
...
static_assert(offsetof(SkinnedDecalSampler_SpawnDecal, WorldLocation) == 0x000000, "Member 'SkinnedDecalSampler_SpawnDecal::WorldLocation' has a wrong offset!");
static_assert(offsetof(SkinnedDecalSampler_SpawnDecal, WorldRotation) == 0x000010, "Member 'SkinnedDecalSampler_SpawnDecal::WorldRotation' has a wrong offset!");
