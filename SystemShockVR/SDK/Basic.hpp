...
namespace Offsets
{
	constexpr int32 GObjects          = 0x04F81680;
	constexpr int32 AppendString      = 0x0131E450;
	constexpr int32 GNames            = 0x04F46740;
	constexpr int32 GWorld            = 0x050C6058;
	constexpr int32 ProcessEvent      = 0x01521440;
