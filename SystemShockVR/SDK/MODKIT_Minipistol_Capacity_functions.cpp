...
#include "MODKIT_Minipistol_Capacity_classes.hpp"
#include "MODKIT_Minipistol_Capacity_parameters.hpp"
...
void UMODKIT_Minipistol_Capacity_C::TryApplyWeaponModifications(class UITEM_WeaponBase_C* Weapon, bool DuringInitialization, bool* Result)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("MODKIT_Minipistol_Capacity_C", "TryApplyWeaponModifications");

	Params::MODKIT_Minipistol_Capacity_C_TryApplyWeaponModifications Parms{};
...
void UMODKIT_Minipistol_Capacity_C::GetModifiedWeaponMode(const struct FSTRUCT_WeaponMode& WeaponMode, struct FSTRUCT_WeaponMode* ResultMode)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("MODKIT_Minipistol_Capacity_C", "GetModifiedWeaponMode");

	Params::MODKIT_Minipistol_Capacity_C_GetModifiedWeaponMode Parms{};
