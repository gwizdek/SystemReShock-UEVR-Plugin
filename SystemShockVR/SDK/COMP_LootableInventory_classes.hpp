...
public:
	...
	TMulticastInlineDelegate<void()>              OnLootInventoryInitialized;                        // 0x0130(0x0010)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, BlueprintAssignable, BlueprintCallable)
