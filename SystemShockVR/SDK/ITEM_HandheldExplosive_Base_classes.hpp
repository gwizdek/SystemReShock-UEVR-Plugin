...
public:
	...
	TMulticastInlineDelegate<void(class UITEM_Base_C* ExplosiveWeapon, int32 Count)> ExplosiveCountChanged;                             // 0x03D8(0x0010)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, BlueprintAssignable, BlueprintCallable)
