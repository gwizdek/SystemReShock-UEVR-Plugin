...
public:
	...
	TMulticastInlineDelegate<void(class AINTERACT_LogisticsLift_C* LogisticsLift, class AActor* CargoActor)> OnCargoSpawned;                                    // 0x0448(0x0010)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, BlueprintAssignable, BlueprintCallable)
	TMulticastInlineDelegate<void(class AINTERACT_LogisticsLift_C* LogisticsLift, class AActor* CargoActor)> OnCargoDelivered;                                  // 0x0458(0x0010)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, BlueprintAssignable, BlueprintCallable)
