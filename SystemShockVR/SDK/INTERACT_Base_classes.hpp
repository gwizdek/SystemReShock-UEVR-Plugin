...
public:
	...
	TMulticastInlineDelegate<void(class AINTERACT_Base_C* Interact)> OnInteractLockStateChanged;                        // 0x0240(0x0010)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, BlueprintAssignable, BlueprintCallable)
	...
	TMulticastInlineDelegate<void(class AINTERACT_Base_C* Interact)> OnInteractDestroyed;                               // 0x02B0(0x0010)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, BlueprintAssignable, BlueprintCallable)
