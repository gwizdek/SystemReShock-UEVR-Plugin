...
public:
	...
	TMulticastInlineDelegate<void(class APAWN_Enemy_C* Enemy)> OnEnemyBehaviorStateChanged;                       // 0x0820(0x0010)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, BlueprintAssignable, BlueprintCallable)
