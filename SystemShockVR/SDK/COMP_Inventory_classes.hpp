...
public:
	...
	TMulticastInlineDelegate<void(class UInventoryBag_C* Bag, int32 SlotIndex)> OnBagChanged;                                      // 0x00E0(0x0010)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, BlueprintAssignable, BlueprintCallable)
	TMulticastInlineDelegate<void(class UClass* UpgradeClass, class UClass* DowngradeClass, ENUM_UpgradeResult Result)> OnItemUpgraded;                                    // 0x00F0(0x0010)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, BlueprintAssignable, BlueprintCallable)
