...
{
public:
	TMulticastInlineDelegate<void(class UObject* Object)> Event;                                             // 0x0000(0x0010)(ZeroConstructor, InstancedReference, NativeAccessSpecifierPublic)
};
...
{
public:
	TMulticastInlineDelegate<void()>              Event;                                             // 0x0000(0x0010)(ZeroConstructor, InstancedReference, NativeAccessSpecifierPublic)
};
