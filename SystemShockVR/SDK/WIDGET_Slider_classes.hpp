...
public:
	...
	TMulticastInlineDelegate<void(float NewSliderValue, float NewAbsoluteValue)> OnValueChanged;                                    // 0x02A0(0x0010)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, BlueprintAssignable, BlueprintCallable)
