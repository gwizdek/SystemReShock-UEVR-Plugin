...
// struct FQuat                            WorldRotation                                          (ConstParm, Parm, IsPlainOldData, NoDestructor, NativeAccessSpecifierPublic)
...
int32 USkinnedDecalSampler::SpawnDecal(const struct FVector& WorldLocation, const struct FQuat& WorldRotation, class FName BoneName, float Size, int32 SubUV, int32 Index_0)
{
	static class UFunction* Func = nullptr;
