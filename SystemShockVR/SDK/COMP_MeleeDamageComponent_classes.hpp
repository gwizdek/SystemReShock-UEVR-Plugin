...
public:
	...
	TMulticastInlineDelegate<void(class AActor* OverlapActor, class UPrimitiveComponent* OverlapComponent, class FName HitboxTag, float DamageScale, class UBoxComponent* HitboxComponent)> OnHitboxBeginOverlap;                              // 0x00C0(0x0010)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, BlueprintAssignable, BlueprintCallable)
	TMulticastInlineDelegate<void(class AActor* OverlapActor, class FName HitboxTag)> OnHitboxEndOverlap;                                // 0x00D0(0x0010)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, BlueprintAssignable, BlueprintCallable)
