...
public:
	...
	TMulticastInlineDelegate<void(class UMOVECONTROL_Base_C* MoveControl)> OnMoveControlRegistered;                           // 0x0C08(0x0010)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, BlueprintAssignable, BlueprintCallable)
