...
// helper struct for boolean variables
struct MemoBoolean : public MemoProperty<bool>
{
    MemoBoolean(bool init_value) : MemoProperty<bool>(init_value, init_value) {}

    bool enabled() {
        return MemoProperty::has_changed() && MemoProperty::value;
    }
...
#ifdef _VR_PLUGIN_INPUT_LOGGING
